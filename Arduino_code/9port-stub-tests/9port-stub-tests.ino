//adding a mode for a stub from top level switch to one of the side switches, in mode 5 to mode 5
...
void loop() {
  ...
  if (Serial.available()) {
    ...
    if(ser == 48){    //ASCII for 0
     ...
     if(ser == 115){    //ASCII for s, which stands for "stub"
      mode = -5;
     }
     if(ser == 116){    //ASCII for t, which stands for "stub" + 1
      mode = -55;
     }
  }
